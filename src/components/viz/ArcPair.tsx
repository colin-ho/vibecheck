    ...
    <div className="relative" style={{ width: size, height: size / 2 + 60 }}>
      ...
      <div className="absolute bottom-0 left-0 right-0 flex justify-between px-4">
        ...
        >
          ...
          {leftLabel && (
            <div className="text-[0.65rem] font-semibold tracking-[0.15em] uppercase text-cocoa/60 mt-1">{leftLabel}</div>
          )}
        </motion.div>
        ...
        >
          ...
          {rightLabel && (
            <div className="text-[0.65rem] font-semibold tracking-[0.15em] uppercase text-cocoa/60 mt-1">{rightLabel}</div>
          )}
        </motion.div>
      </div>
    </div>
