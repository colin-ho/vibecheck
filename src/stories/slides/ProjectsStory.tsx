		...
		<SlideLayout>
				...
				<svg width={300} height={300} className="overflow-visible">
					...
					{orbits.map((point, i) => (
						<motion.circle
							...
							r={point.size}
							fill={
								point.orbitIndex === 0 ? '#bdb7fc' : point.orbitIndex === 1 ? '#dd5013' : '#da1c1c'
							}
							...
							style={{
								filter:
									point.orbitIndex === 0
										? 'drop-shadow(0 0 6px rgba(189, 183, 252, 0.5))'
										: undefined,
							}}
						/>
					))}
			...
			>
				<div className="text-center">
					...
					<div className="text-[0.65rem] font-semibold tracking-[0.15em] uppercase text-dark/70 mt-1">
						active days
					</div>
				</div>
				<div className="text-center">
